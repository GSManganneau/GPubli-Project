							...
							<div class="box">
								<div class="box-content">
									<ul>
										...
										<li><a href="page_type.html">Types</a></li>
										<li class="active"><a href="page_team.html">Equipes</a></li>
									</ul>
								</div>
							</div>
						</nav>
						...
						<div class="publications">
							...
							<div class="box box_team">
								...
								<div class="box-content">
									<table>
										<tr>
											<td><a href="#"  class="member">Membre #1</a></td>
											<td><a href="#" class="delete_icon"></a></td>
										</tr>
										<tr>
											<td><a href="#" class="member">Membre #2</a></td>
											<td><a href="#" class="delete_icon"></a></td>
										</tr>
										<tr>
											<td><a href="#" class="member">Membre #3</a></td>
											<td><a href="#" class="delete_icon"></a></td>
										</tr>
									</table>
									<input type="text" id="add_team_mate" class="input_page_team" placeholder="ajouter un membre"><a href="#" class="add_icon"></a>
								</div>
							</div>
